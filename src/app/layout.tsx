...
export const metadata: Metadata = {
  ...
  description: "Advanced clinical training programs for healthcare professionals. Expert-led workshops in emergency medicine, surgical techniques, and clinical skills.",
  keywords: "medical workshop, clinical training, healthcare education, CME credits, professional development",
  robots: {
    index: true,
    follow: true
  },
